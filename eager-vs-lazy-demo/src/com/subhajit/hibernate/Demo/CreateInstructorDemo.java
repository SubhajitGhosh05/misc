...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			Instructor tempInstructor = new Instructor("Rahul","Chahar","rahulchahar@gmail.com");
			InstructorDetail tempInstructorDetail=new InstructorDetail("Chahar TV","Cricketer");
